                ...
                <div className="modal-dialog">
                    ...
                    <div className="modal-body table-responsive">
                        ...
                        <thead>
                            ...
                            <th scope="col"  className='text-light'>Produto</th>
                            <th scope="col" className='text-light'>Qtd</th>
                            <th scope="col" className='text-light'>Preço</th>
                            <th scope="col" className='text-light'></th>
                            <th scope="col" className='text-light'></th>
                            ...
                            {cart.Cart.map( item =>{
                                return(
                                    <tr key={item.id}>
                                        ...
                                        <th className='text-light'>R$ {item.price.toFixed(2)}</th>
                                        ...
                                        <th className='text-light'>R$ {(item.price * item.quantity).toFixed(2)}</th>
                                    </tr>
                                )
                            })}
                            <tr>
                            <th colSpan="2" scope="col" className='text-light'>Total</th>
                            <th colSpan="3" className='text-light'>{cart.value} itens</th>
                            <th colSpan="2" className='text-light'>R$ {totalPrice.toFixed(2)}</th>
                            </tr>
                        </tbody>
                        </table>
                        </div>
